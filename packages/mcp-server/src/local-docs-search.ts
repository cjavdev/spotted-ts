...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ id?: string; account_id?: string; country?: string; display_name?: string; email?: string; explicit_content?: { filter_enabled?: boolean; filter_locked?: boolean; published?: boolean; }; external_urls?: { published?: boolean; spotify?: string; }; followers?: { href?: string; published?: boolean; total?: number; }; href?: string; images?: { height: number; url: string; width: number; published?: boolean; }[]; product?: string; published?: boolean; type?: string; uri?: string; }',
    markdown:
      "## retrieve\n\n`client.me.retrieve(): { id?: string; account_id?: string; country?: string; display_name?: string; email?: string; explicit_content?: object; external_urls?: external_url_object; followers?: followers_object; href?: string; images?: image_object[]; product?: string; published?: boolean; type?: string; uri?: string; }`\n\n**get** `/me`\n\nGet detailed profile information about the current user (including the\ncurrent user's username).\n\n\n### Returns\n\n- `{ id?: string; account_id?: string; country?: string; display_name?: string; email?: string; explicit_content?: { filter_enabled?: boolean; filter_locked?: boolean; published?: boolean; }; external_urls?: { published?: boolean; spotify?: string; }; followers?: { href?: string; published?: boolean; total?: number; }; href?: string; images?: { height: number; url: string; width: number; published?: boolean; }[]; product?: string; published?: boolean; type?: string; uri?: string; }`\n\n  - `id?: string`\n  - `account_id?: string`\n  - `country?: string`\n  - `display_name?: string`\n  - `email?: string`\n  - `explicit_content?: { filter_enabled?: boolean; filter_locked?: boolean; published?: boolean; }`\n  - `external_urls?: { published?: boolean; spotify?: string; }`\n  - `followers?: { href?: string; published?: boolean; total?: number; }`\n  - `href?: string`\n  - `images?: { height: number; url: string; width: number; published?: boolean; }[]`\n  - `product?: string`\n  - `published?: boolean`\n  - `type?: string`\n  - `uri?: string`\n\n### Example\n\n```typescript\nimport Spotted from 'spotted-ts';\n\nconst client = new Spotted();\n\nconst me = await client.me.retrieve();\n\nconsole.log(me);\n```",
    perLanguage: {
      typescript: {
