...
import list_me_following from './me/following/list-me-following';
...
import list_chapters from './chapters/list-chapters';
import retrieve_tracks from './tracks/retrieve-tracks';
import list_tracks from './tracks/list-tracks';
import retrieve_search from './search/retrieve-search';
...
import list_audio_features from './audio-features/list-audio-features';
...
addEndpoint(list_chapters);
addEndpoint(retrieve_tracks);
addEndpoint(list_tracks);
addEndpoint(retrieve_search);
...
addEndpoint(list_audio_features);
