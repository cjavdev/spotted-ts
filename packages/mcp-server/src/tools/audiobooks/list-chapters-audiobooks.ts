...
export const handler = async (client: Spotted, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.audiobooks.listChapters(id, body).asResponse();
  try {
