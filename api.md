...
- <code><a href="./src/resources/me/top.ts">TopListResponse</a></code>

Methods:

- <code title="get /me/top/{type}">client.me.top.<a href="./src/resources/me/top.ts">list</a>(type, { ...params }) -> TopListResponsesCursorURLPage</code>
